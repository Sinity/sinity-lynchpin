...
class SessionProfile:
    ...
    work_event_projects: tuple[str, ...]  # repo names/paths from current Polylogue products
...
**Exports**: `SleepSegment`, `SleepMetrics`, `SleepEntry`, `SleepStageRecord`, `SleepArchitecture`, `SleepProductivity`
...
| `sleep_stages(*, start, end)` | `start: Optional[date] = None, end: Optional[date] = None` | `list[SleepStageRecord]` |
| `sleep_architecture(*, start, end)` | `start: Optional[date] = None, end: Optional[date] = None` | `list[SleepArchitecture]` |
...
**Exports**: `StepDay`, `StressMeasurement`, `HRVMeasurement`, `VitalityDay`, expanded health loaders
...
| `heart_rate_measurements(*, start, end)` | `start: Optional[date] = None, end: Optional[date] = None` | `list[HeartRateMeasurement]` |
| `spo2_measurements(*, start, end)` | `start: Optional[date] = None, end: Optional[date] = None` | `list[SpO2Measurement]` |
| `respiratory_rate(*, start, end)` | `start: Optional[date] = None, end: Optional[date] = None` | `list[RespiratoryMeasurement]` |
| `ecg_measurements(*, start, end)` | `start: Optional[date] = None, end: Optional[date] = None` | `list[ECGMeasurement]` |
| `activity_summaries(*, start, end)` | `start: Optional[date] = None, end: Optional[date] = None` | `list[ActivityDaySummary]` |
| `movement_records(*, start, end)` | `start: Optional[date] = None, end: Optional[date] = None` | `list[MovementRecord]` |
| `calorie_burns(*, start, end)` | `start: Optional[date] = None, end: Optional[date] = None` | `list[CalorieBurn]` |
| `nap_sessions(*, start, end)` | `start: Optional[date] = None, end: Optional[date] = None` | `list[NapSession]` |
| `daily_health_summary(*, start, end)` | `start: Optional[date] = None, end: Optional[date] = None` | `list[DailyHealthSummary]` |
