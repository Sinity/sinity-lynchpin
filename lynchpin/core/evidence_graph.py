...
EvidenceNodeKind = Literal[
    ...
    "terminal_pattern",
    "machine_episode",
    "machine_context_window",
    "machine_below_attribution",
    "machine_workload_resource_attribution",
    "machine_baseline",
    "machine_work_observation",
    "machine_work_stage_summary",
    "machine_work_test_summary",
    "machine_work_failure_summary",
    "machine_analysis_feature_frame",
    "machine_mining_scan",
    "machine_observation_cohort",
    "machine_lagged_exposure_summary",
    "machine_anomaly_cluster",
    "machine_boundary_candidate",
    "machine_matched_design",
    "machine_matched_comparison",
    "machine_cohort_contrast",
    "machine_attribution_candidate",
    "machine_benchmark_plan",
    "machine_benchmark_manifest_group",
    "machine_benchmark_run_template",
    "machine_benchmark_preflight_run",
    "machine_benchmark_execution_handoff_item",
    "machine_benchmark_run",
    "machine_benchmark_phase",
    "machine_benchmark_estimate",
    "machine_support_assessment",
    "machine_experiment_manifest_diagnostics",
    "machine_experiment_manifest_diagnostic",
    "machine_experiment_claim",
    "machine_mechanism_hypothesis",
    "machine_negative_control",
    "machine_calibration_fixture",
    "machine_measurement_check",
    "machine_instrumentation_gap",
    "machine_assumption_check",
    "machine_pressure_incident",
    "listening_session",
    "web_domain_day",
    "sleep_quality",
...
EvidenceRelation = Literal[
    ...
    "contrast_estimates_cohort",
    "comparison_matches_cohorts",
    "benchmark_plan_for_candidate",
    ...
    "support_assessment_for_candidate",
    "mechanism_explains_candidate",
    "mechanism_summarizes_assessment",
    "negative_control_checks_candidate",
    "instrumentation_gap_blocks_mechanism",
    "instrumentation_gap_blocks_assessment",
    "instrumentation_gap_blocks_candidate",
