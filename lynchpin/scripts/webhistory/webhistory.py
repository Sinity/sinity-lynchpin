...
The commands here are the explicit write surface for the read-only helpers in
`lynchpin.sources.web`: dedup raw exports, compare canonical datasets, build
merged NDJSON, and audit the materialized output against raw inputs.
"""
