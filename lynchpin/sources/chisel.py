...
_plan(
    "sinex", "/realm/project/sinex", "Sinity/sinex",
    Slice(
        "code-proper",
    ...
    stats_buckets=(
        ...
        StatsBucket(
            ...
            ("crate/sinex-db/src/**", "crate/sinex-db/sql/**", "crate/sinex-db/Cargo.toml"),
        ),
        StatsBucket(
            "code-primitives",
        ...
        StatsBucket(
            ...
            ("crate/sinexctl/src/**", "crate/sinexctl/config.example.toml", "crate/sinexctl/Cargo.toml"),
        ),
        StatsBucket(
            "code-xtask",
...
_plan(
    "sinnix", "/realm/project/sinnix", "Sinity/sinnix",
    Slice("hosts-and-modules",     "Host profiles, Nix modules, flake composition",
          ("hosts/**", "modules/**", "flake/**", "flake.nix")),
    Slice("scripts-and-dots",      "Scripts, dotfiles, agent control plane, CI",
    ...
    stats_buckets=(
        ...
        StatsBucket("flake", "Flake parts, package data, overlays, and npm metadata", ("flake/**", "flake.nix")),
        StatsBucket("dots", "Home-manager dotfiles and agent configuration", ("dots/**",)),
        StatsBucket("scripts", "Operational scripts", ("scripts/**",)),
        StatsBucket("pkgs", "Local package sources and tests", ("pkgs/**",)),
        StatsBucket("docs", "Repository documentation and incident notes", ("docs/**", "README.md", "CLAUDE.md")),
        StatsBucket("agent-context", "Agent instructions and GitHub metadata", (".agent/**", ".github/**", "agent/**")),
        StatsBucket("assets-and-eval", "Assets and evaluations", ("assets/**", "eval/**")),
    ),
)
...
_plan(
    "polylogue", "/realm/project/polylogue", "Sinity/polylogue",
    Slice("core-and-storage",      "Core library, package roots, storage backends, schemas, sources",
          ("polylogue/*.py", "polylogue/lib/**", "polylogue/storage/**", "polylogue/schemas/**",
           "polylogue/sources/**", "README.md")),
    Slice("cli-mcp-and-operations","CLI, MCP server, operational automation, UI glue",
          ("polylogue/cli/**", "polylogue/mcp/**", "polylogue/operations/**",
           "polylogue/ui/**", "scripts/**", ".github/**", "AGENTS.md")),
    Slice("agent-workspace",       "Agent conventions, scripts, task ledgers, reports, and tools",
          (".agent/CONVENTIONS.md", ".agent/README.md", ".agent/scripts/**",
           ".agent/task-history/**", ".agent/xtask/**", ".agent/tools/**",
           ".agent/reports/**", ".agent/learnings.local.md", ".github/**"),
          extra_ignore=(".agent/task-history/*.jsonl", ".agent/xtask/*.jsonl")),
    Slice("agent-demos-and-prompts","Agent demos, cloud prompts, and proposed issue packets",
          (".agent/demos/**", ".agent/cloud-prompts/**", ".agent/proposed_issue_set/**"),
          extra_ignore=(".agent/demos/chatlog-exports/**/full-chatlog/**",)),
    Slice("rendering-and-site",    "Rendering engine, site generation, demos, templates",
          ("polylogue/rendering/**", "polylogue/site/**", "polylogue/showcase/**",
           "polylogue/templates/**", "demos/**")),
    Slice("docs",                  "Documentation",
          ("docs/**", "CLAUDE.md", "CHANGELOG.md")),
    Slice("tests-and-qa",          "Tests and QA campaigns",
          ("tests/**", "qa/**")),
    stats_buckets=(
        StatsBucket("agent-workspace", "Agent conventions, scripts, task ledgers, reports, tools, and GitHub metadata", (".agent/CONVENTIONS.md", ".agent/README.md", ".agent/scripts/**", ".agent/task-history/**", ".agent/xtask/**", ".agent/tools/**", ".agent/reports/**", ".agent/learnings.local.md", ".github/**")),
        StatsBucket("agent-demo-raw-exports", "Large raw demo payloads kept out of the default demo context slice", (".agent/demos/chatlog-exports/**/full-chatlog/**",)),
        StatsBucket("agent-demos-prompts", "Agent demos, cloud prompts, and proposed issue packets", (".agent/demos/**", ".agent/cloud-prompts/**", ".agent/proposed_issue_set/**")),
        StatsBucket("agent-archive", "Archived or retired agent workspace material, separated from active devloop state", (".agent/archive/**",)),
        StatsBucket("tests-and-qa", "Tests, QA, fixtures, visual and benchmark suites", ("tests/**", "qa/**")),
        StatsBucket("docs", "Documentation, plans, product notes, and markdown surfaces", ("docs/**", "README.md", "AGENTS.md", "CLAUDE.md", "CHANGELOG.md", "CONTRIBUTING.md", "TESTING.md")),
        StatsBucket("archive-query", "Archive query and expression code", ("polylogue/archive/query/**",)),
        StatsBucket("archive-data", "Archive data, semantic artifacts, and stored products", ("polylogue/archive/**", "polylogue/artifacts/**")),
        StatsBucket("daemon", "Daemon runtime, status, HTTP, metrics, and service code", ("polylogue/daemon/**",)),
        StatsBucket("api-and-surfaces", "API, surfaces, browser capture, telemetry, and public payloads", ("polylogue/api/**", "polylogue/surfaces/**", "polylogue/browser_capture/**", "polylogue/telemetry/**")),
        StatsBucket("core-and-storage", "Core library, package roots, storage, schemas, sources, paths, and cost modules", ("polylogue/*.py", "polylogue/core/**", "polylogue/lib/**", "polylogue/storage/**", "polylogue/schemas/**", "polylogue/sources/**", "polylogue/paths/**", "polylogue/cost/**", "polylogue/publication/**")),
        StatsBucket("pipeline-product-readiness", "Pipeline, product, readiness, insight, and verification code", ("polylogue/pipeline/**", "polylogue/product/**", "polylogue/readiness/**", "polylogue/insights/**", "polylogue/verification/**")),
        StatsBucket("cli-mcp-operations", "CLI, MCP, operations, maintenance, context, and scripts", ("polylogue/cli/**", "polylogue/mcp/**", "polylogue/operations/**", "polylogue/maintenance/**", "polylogue/context/**", "scripts/**", "systemd/**")),
        StatsBucket("rendering-and-site", "Rendering, UI, site, showcase, templates, scenarios, demos, and browser extension", ("polylogue/rendering/**", "polylogue/ui/**", "polylogue/site/**", "polylogue/showcase/**", "polylogue/templates/**", "polylogue/scenarios/**", "polylogue/demo/**", "demos/**", "browser-extension/**")),
        StatsBucket("devtools-packaging-nix", "Developer tools, packaging, contrib, Nix, hooks, and release automation", ("devtools/**", "packaging/**", "contrib/**", "nix/**", "pyproject.toml", "flake.nix", ".githooks/**", ".coderabbit.yaml", ".release-please-manifest.json", "release-please-config.json")),
    ),
)
...
_plan(
    "sinity-lynchpin", "/realm/project/sinity-lynchpin", None,
    Slice("analysis-and-core",     "Analysis modules, core primitives, config, control plane",
          ("lynchpin/analysis/**", "lynchpin/core/**", "config/**",
           "README.md", "CLAUDE.md", "pyproject.toml")),
    Slice("sources",               "Read-only data source adapters",
          ("lynchpin/sources/**",)),
    Slice("composite-graph-spine", "Evidence graph, context packs, semantic products",
          ("lynchpin/graph/**",)),
    Slice("cli-and-tooling",       "CLI entrypoints and tooling",
          ("lynchpin/cli/**", "tool/**", "justfile")),
    Slice("tests",                 "Test suites",
          ("tests/**",)),
    Slice("docs",                  "Documentation",
          ("docs/**",)),
    stats_buckets=(
        StatsBucket("analysis", "Analysis modules and reports", ("lynchpin/analysis/**",)),
        StatsBucket("core", "Core primitives, parsing, config, cache, and errors", ("lynchpin/core/**",)),
        StatsBucket("sources", "Source adapters", ("lynchpin/sources/**",)),
        StatsBucket("graph", "Evidence graph and context-pack spine", ("lynchpin/graph/**",)),
        StatsBucket("mcp", "MCP server tools and read surfaces", ("lynchpin/mcp/**",)),
        StatsBucket("substrate", "DuckDB substrate schema, promoters, readers, and snapshots", ("lynchpin/substrate/**",)),
        StatsBucket("ingest", "Ingest and materialization tools", ("lynchpin/ingest/**", "lynchpin/materialization.py")),
        StatsBucket("cli-tooling", "CLI entrypoints, local tools, and justfile", ("lynchpin/cli/**", "tool/**", "justfile")),
        StatsBucket("tests", "Test suite", ("tests/**",)),
        StatsBucket("docs", "Documentation", ("docs/**", "README.md", "CLAUDE.md")),
        StatsBucket("config", "Project configuration and generated static surfaces", ("pyproject.toml", "config/**", "lynchpin/web/**", "lynchpin/static/**")),
    ),
    extra_ignore=(
        "retrospective/**",
        ".agent/**",
...
_plan(
    "knowledgebase", "/realm/data/knowledgebase", "Sinity/knowledgebase",
    Slice("permanent",             "Authored knowledge: reflections, ideas, concepts, self-analysis, MOCs",
          ("permanent.*",)),
    Slice("extrinsic-chatlogs-reports", "AI chatlogs and analysis reports",
          ("extrinsic.chatlog.*", "extrinsic.report.*", "extrinsic.psychometry.*")),
    Slice("extrinsic-docs-comms",  "External documents, psychometric tests, communications",
          ("extrinsic.doc.*", "extrinsic.comms.*", "extrinsic.misc.*")),
    Slice("logs-inbox-archive",    "Journals, raw logs, inbox captures, archived notes",
          ("logs.*", "inbox.*", "archive.*")),
    Slice("infrastructure",        "Vault machinery: schemas, scripts, templates, projects, config",
          ("schemas/**", "scripts/**", "templates.*", "projects.*",
           "root.md", "root.schema.yml", "CLAUDE.md", "dendron.yml", "plan.txt", "README.md")),
...
def _run_slice(
    repomix_bin: str, output_dir: Path,
    plan: RepoPlan, slice: Slice, git: dict, generated_at: str,
    log: list[str] | None = None,
) -> tuple[str, int]:
    ...
    args = [
        "--style", "xml", "--parsable-style", "--quiet", "--no-security-check",
        *gitignore_args,
        "--include-full-directory-structure", "--output-show-line-numbers",
        "--header-text", _slice_header(plan, slice, git, generated_at),
        "--include", ",".join(slice.include),
        "--ignore", _ignore_str(plan, slice),
...
def _run_compressed(
    repomix_bin: str, output_dir: Path,
    plan: RepoPlan, git: dict, generated_at: str,
    log: list[str] | None = None,
) -> tuple[str, int]:
    ...
    args = [
        ...
        "--header-text", _compressed_header(plan, git, generated_at),
        "--include", ",".join(include_patterns),
        "--ignore", _ignore_str(plan),
        "--output", str(output_path),
    ]
    name, size = _run_repomix(repomix_bin, output_path, plan, args, git, generated_at, log)
...
def _run_scratchpad(
    ...
    args = [
        ...
        "--include-full-directory-structure", "--output-show-line-numbers",
        "--header-text", header,
        "--include", ",".join(_SCRATCHPAD_INCLUDE),
        "--output", str(output_path),
    ]
    try:
        name, size = _run_repomix(repomix_bin, output_path, plan, args, git, generated_at, log)
...
def _run_accelerants(
    ...
    args = [
        ...
        "--include-full-directory-structure", "--output-show-line-numbers",
        "--header-text", header,
        "--include", ",".join(_ACCELERANT_INCLUDE),
        "--ignore", ",".join(_ACCELERANT_IGNORE),
        "--output", str(output_path),
    ]
    try:
        name, size = _run_repomix(repomix_bin, output_path, plan, args, git, generated_at, log)
...
def _collect_tokei_stats(plan: RepoPlan, generated_at: str) -> dict[str, Any]:
    ...
    return {
        ...
        "buckets": dict(sorted(
            buckets.items(),
            key=lambda item: (
                999 if item[0] == "other" else list(bucket_descriptions).index(item[0])
                if item[0] in bucket_descriptions else 998,
                item[0],
            ),
        )),
        "files": sorted(files, key=lambda row: (row["bucket"], row["path"])),
        "rust_inline_tests": _rust_inline_test_stats(plan),
        "rust_split_test_files": _rust_split_test_file_stats(plan),
    }
...
def _rust_inline_test_stats(plan: RepoPlan) -> dict[str, Any]:
    ...
    return {
        ...
        "blocks": total_blocks,
        "lines": total_lines,
        "by_member": dict(sorted(by_member.items(), key=lambda item: (-item[1]["lines"], item[0]))),
        "largest_files": sorted(largest, key=lambda row: (-row["lines"], row["path"]))[:25],
        "note": (
...
def _github_context_summary() -> str:
    ...
    if noisy_reasons:
        parts.append(
            "hydrate reasons "
            + ", ".join(f"{key}={value}" for key, value in sorted(noisy_reasons.items()))
        )
...
def _build_issues_xml(issues: list[dict], repo_slug: str, state: str, generated_at: str) -> str:
    root = ET.Element("issues", {
        "repository": repo_slug, "state": state,
        "generated-at": generated_at, "count": str(len(issues)),
    })
    for iss in issues:
        el = ET.SubElement(root, "issue", {
            "number": str(iss.get("number", "")), "state": iss.get("state", ""),
            "created-at": iss.get("createdAt", ""), "updated-at": iss.get("updatedAt", ""),
            "url": iss.get("url", ""),
        })
        ...
        for c in iss.get("_comments", []):
            ce = ET.SubElement(comments, "comment", {
        ...
        "reviews": [
            {
                ...
                "state": review.state,
                "body": review.body,
                "submittedAt": review.submitted_at.isoformat() if review.submitted_at else "",
            }
...
def _build_prs_xml(prs: list[dict], repo_slug: str, state: str, generated_at: str) -> str:
    root = ET.Element("prs", {
        "repository": repo_slug, "state": state,
        "generated-at": generated_at, "count": str(len(prs)),
    })
    for pr in prs:
        el = ET.SubElement(root, "pr", {
            "number": str(pr.get("number", "")), "state": pr.get("state", ""),
            "created-at": pr.get("createdAt", ""), "merged-at": pr.get("mergedAt", ""),
            "url": pr.get("url", ""), "merge-commit": pr.get("mergeCommit", ""),
        })
        t = ET.SubElement(el, "title")
        t.text = pr.get("title", "")
        b = ET.SubElement(el, "body")
        ...
        for rv in pr.get("_reviews", []):
            re_el = ET.SubElement(reviews, "review", {
    ...
    *,
    ...
    for issue in issues:
        ...
        for edge in dep_map.get(issue_id, ()):
            ET.SubElement(deps_el, "dependency", {
        ...
        if isinstance(comments, list):
            for comment in comments:
                if not isinstance(comment, dict):
                    continue
                comment_el = ET.SubElement(comments_el, "comment", {
...
def _generate_git_log(
    ...
    root = ET.Element("git-log", {
        "repository": str(plan.path), "refs": "all",
        "style": "all-refs", "generated-at": generated_at,
    })
    ...
    for block in result.stdout.split("\x1e"):
        ...
        commit = ET.SubElement(root, "commit", {
            "sha": sha.strip("\x00"), "author": author, "email": email, "date": date,
        })
        if refs.strip():
...
def _generate_portable_sidecars(
    ...
    archive = _run(
         ...
         *_WORKTREE_TAR_EXCLUDES, *plan_excludes,
         "-C", str(plan.path.parent), plan.path.name],
    )
...
def _generate_ignore_audit(plan: RepoPlan, out_dir: Path, log: list[str] | None = None) -> tuple[list[str], int]:
    ...
    for child in sorted(plan.path.iterdir(), key=lambda p: p.name):
        ...
        matched_patterns = [
            pattern for pattern in (*DEFAULT_IGNORE, *plan.extra_ignore)
    ...
    audit = {
        ...
        "source": str(plan.path),
        "entries": entries,
        "ignored_local_state_bytes": sum(e["bytes"] for e in entries if e["ignored"] and e["local_state"]),
...
def _agent_audit_rows(agent_dir: Path, repo_root: Path) -> list[dict[str, Any]]:
    ...
    def add(path: Path) -> None:
        ...
        rows.append({
            ...
            "files": sum(1 for child in path.rglob("*") if child.is_file()) if path.is_dir() else 1,
            "class": cls,
...
def _generate_snapshot_overview(
    ...
    *,
    ...
    large_artifacts = [
        row for row in sorted(artifacts, key=lambda item: int(item["bytes"]), reverse=True)
...
def _generate_snapshot_audit(
    ...
    *,
    ...
    audit = {
        "project": plan.name,
        "generated_at": generated_at,
        "status": "attention" if (overview.get("attention") or {}).get("large_artifacts") else "ok",
        "counts": overview.get("counts") or {},
        "size": {
            "total_bytes": sum(int(row["bytes"]) for row in artifacts),
            "largest_artifacts": sorted(artifacts, key=lambda item: int(item["bytes"]), reverse=True)[:12],
            "largest_deltas": size_delta,
        },
        "agent_workspace": {
            "summary_by_class": agent_summary,
            "active_context_entries": int((agent_summary.get("active-context") or {}).get("entries") or 0),
            "devloop_entries": int((agent_summary.get("transient-heavy") or {}).get("entries") or 0),
            "archive_or_generated_bytes": int((agent_summary.get("archive-or-generated") or {}).get("bytes") or 0),
        },
        "local_state": {
            "ignored_local_state_bytes": int(ignore_audit.get("ignored_local_state_bytes") or 0),
            "tracked_hidden_bytes": int(ignore_audit.get("tracked_hidden_bytes") or 0),
        },
        "branch_delta": {
            "patch_bytes": int(((overview.get("attention") or {}).get("branch_delta_patch_bytes")) or 0),
        },
        "beads": {
        ...
        "github_context": {
            ...
            "project_stale_open_removed": github.get("project_stale_open_removed") or {},
        },
...
def _write_root_index(
    ...
    for plan in plans:
        ...
        projects.append({
            ...
            "manifest": str(manifest_path.relative_to(output_root)) if manifest_path.exists() else None,
            "overview_markdown": f"{plan.name}/{plan.name}-overview.md" if (output_root / plan.name / f"{plan.name}-overview.md").exists() else None,
            "snapshot_audit_markdown": f"{plan.name}/{plan.name}-snapshot-audit.md" if (output_root / plan.name / f"{plan.name}-snapshot-audit.md").exists() else None,
        })
...
def _build_one(
    ...
    if not plan.path.exists():
        return {
            "project": plan.name,
            "status": "missing",
            "log_lines": [f"[bold]{plan.name}[/bold]  [red]missing[/red]  [dim]{plan.path}[/dim]"],
        }
...
def build_chisel_bundles(
    *,
    ...
    _github_context_ready = None  # reset per-run so repeated calls in the same process work
    ...
    futures = {
        ex.submit(_build_one, plan, output_root, repomix_bin, generated_at, slice_workers): plan.name
        for plan in plans
    }
    try:
        completed = 0
    ...
    if _console is not None:
        ...
        for plan in plans:
            ...
            table.add_row(
                plan.name, f"[{color}]{status_label}[/{color}]", snapshots,
                issues, prs, commits, _fmt_bytes(size), elapsed,
            )

        table.add_section()
        table.add_row(
            "[bold]TOTAL[/bold]", "", "", "", "", "",
            _fmt_bytes(total_bytes), f"{total_elapsed:.1f}s",
        )
...
def run_from_cli(argv: list[str] | None = None) -> int:
    ...
    ap.add_argument("--output-root", type=_parse_optional_path, default=None,
