    ...
    return (
        ObservabilityInput(
            ...
            next_action=(
                ...
                "service_cgroup_io_sample, service_cgroup_pressure_sample, "
                "and cgroup_memory_sample "
        ...
        ObservabilityInput(
            ...
            retention="operational recorder history under /var/log/below",
            next_action="do not promote wholesale; export bounded windows when experiments need process attribution",
        ),
        ObservabilityInput(
            ...
            path=cfg.sinnix_root / "pkgs/sinnix-observe",
            substrate_table=None,
        ...
        ObservabilityInput(
            id="machine.sinnix_runtime_inventory",
            owner="sinnix",
            layer="operational_view",
            integration_state="reference_only",
            path=cfg.sinnix_runtime_inventory_json,
            substrate_table=None,
            grain="generated runtime and capture inventory",
            state_dimensions=(
                "runtime_class_inventory",
                "command_class_inventory",
                "service_inventory",
                "capture_inventory",
                "mount_inventory",
                "backup_inventory",
            ),
            retention="generated by the active Sinnix system configuration",
            next_action="use as source-discovery context for machine analysis; do not promote as facts",
        ),
        ObservabilityInput(
