        ...
        while True:
            ...
            for prof in profiles:
                ...
                if inf:
                    ...
                    inf_projects = list(d.get("canonical_projects") or [])
    ...
    try:
        result = subprocess.run(
            [_POLYLOGUE_PYTHON, "-c",
             ...
             "    async with Polylogue() as p:\n"
             "        s=await p.stats()\n"
             "        json.dump({'conversations':s.conversations,'messages':s.messages,'providers':s.providers},sys.stdout)\n"
             "asyncio.run(m())\n"],
    ...
    async with Polylogue() as p:
        ...
        for d in days:
            ...
            results.append({
                ...
                "projects_active": list(sd.get("projects_active") or []),
            ...
            if result.returncode != 0:
                ...
                _cached_day_summaries = [
                    DaySessionSummary(
                        ...
                        projects_active=tuple(r.get("projects_active", [])),
