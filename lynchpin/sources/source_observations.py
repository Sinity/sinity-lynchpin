...
def _configured_path(source: str) -> Path | None:
    ...
    mapping: dict[str, Path | None] = {
        ...
        "notifications": cfg.captures_root / "notifications",
        "mpris": cfg.captures_root / "mpris",
        "audio_index": cfg.captures_root / "audio-index",
        "audio_topology": cfg.captures_root / "audio-topology",
