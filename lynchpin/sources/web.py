...
- raw exports under `/realm/activity/webhistory/gestalt/raw/`
- deduped canonical segments under `/realm/activity/webhistory/gestalt/data/`
- merged NDJSON under `/realm/activity/webhistory/gestalt/derived/full_history.ndjson`
