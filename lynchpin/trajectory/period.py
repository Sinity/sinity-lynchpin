...
def summarize_period(days: Sequence[TrajectoryDay]) -> TrajectoryPeriodSummary:
    if not days:
        return TrajectoryPeriodSummary(
            start_date="",
            end_date="",
            total_days=0,
            active_seconds=0.0,
            ...
            dominant_projects=(),
            source_counts={},
            coverage={"days_with_activitywatch": 0, "days_with_terminal": 0, "days_with_chatlog": 0, "days_with_git": 0},
            highlights=(),
        )
...
def summarize_months(days: Sequence[TrajectoryDay]) -> dict[str, TrajectoryPeriodSummary]:
