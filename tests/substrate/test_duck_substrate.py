...
# All these tests import from lynchpin.substrate.promote and lynchpin.substrate.reader.
...
def _try_import_promote_reader():
    ...
    try:
        import lynchpin.substrate.promote as promote_mod
        import lynchpin.substrate.reader as reader_mod
...
def test_finalize_graph_writes_to_substrate(
    ...
    """_finalize_graph always writes to substrate (Arc 3: gate removed)."""
