...
from lynchpin.composite.context_pack import context_pack, graph_context_pack, render_context_pack
from lynchpin.composite.current_state import CurrentStateEvidencePack
from lynchpin.composite.evidence import EvidenceCaveat, SourceReadiness, SourceReadinessReport
from lynchpin.composite.evidence_graph import EvidenceGraph, EvidenceNode
from lynchpin.composite.movement import movement_summary, render_movement_summary
from lynchpin.composite.work_correlation import CorrelatedWorkDay, WorkCorrelationSummary
...
def test_context_pack_filters_projects_and_renders_caveats(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("lynchpin.composite.context_pack.current_state_evidence_pack", lambda **kwargs: pack)
    monkeypatch.setattr(
        "lynchpin.composite.context_pack.build_evidence_graph",
...
def test_context_pack_can_include_semantic_enrichment(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("lynchpin.composite.context_pack.current_state_evidence_pack", lambda **kwargs: pack)
    monkeypatch.setattr("lynchpin.composite.context_pack.build_evidence_graph", lambda **kwargs: graph)
