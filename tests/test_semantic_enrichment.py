...
from lynchpin.composite.semantic_enrichment import build_semantic_enrichment, render_semantic_summary, save_semantic_enrichment
UTC = timezone.utc
...
def test_semantic_enrichment_persistence_uses_configured_cache(monkeypatch, tmp_path):
    monkeypatch.setattr('lynchpin.composite.semantic_enrichment._semantic_db_path', lambda: tmp_path / 'semantic.sqlite3')
    enrichment = build_semantic_enrichment(_graph())
